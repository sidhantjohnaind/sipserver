...
static void on_incoming_call(pjsua_acc_id acc_id, pjsua_call_id call_id,
    ...
    if (inv_pool) {
        ...
        std::string pub_id_raw = get_env_def("PUBLIC_ID", "sip:+916513585849@br.wln.ims.jio.com");
...
static int run_b2bua_server() {
    ...
    std::string pub_id  = get_env_def("PUBLIC_ID", "sip:+916513585849@br.wln.ims.jio.com");
    std::string s_auth  = get_env_def("SIP_AUTH_USER", "916513585849@br.wln.ims.jio.com");
