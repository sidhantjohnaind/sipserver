...
static void on_incoming_call(pjsua_acc_id acc_id, pjsua_call_id call_id,
    ...
    if (inv_pool) {
        ...
        const char *pid = (pub_id_raw && *pub_id_raw) ? pub_id_raw : "sip:+910000000000@br.wln.ims.jio.com";
        if (pid[0] != '<') {
...
int main(int argc, char *argv[]) {
    ...
    if (pub_id_raw && *pub_id_raw) {
        ...
        snprintf(clean_pub_id, sizeof(clean_pub_id), "sip:+910000000000@br.wln.ims.jio.com");
    }
